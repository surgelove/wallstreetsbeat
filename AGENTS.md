...
- **Playable area**: 1920×1080 (16:9). Design resolution is 1920×1080 directly in `BASE_W, BASE_H`, scaled via `sx()/sy()`
...
- Font sizes use `sy()`: `love.graphics.newFont("fonts/default.ttf", sy(20))` — value is in 1920×1080 reference
