return {
  ...
  algos = {
    ...
    { key = "algo6",  label = "ALGO 6", color = {0.70, 0.30, 0.85} },
    { key = "algo7",  label = "ALGO 7", color = {0.05, 0.40, 0.15} },
    { key = "algo8",  label = "ALGO 8", color = {0.72, 0.19, 0.30} },
    { key = "algo9",  label = "ALGO 9", color = {0.25, 0.50, 0.80} },
  },
  canvasSprites = {
    { file = "bear.png" },
    { file = "blob_fish.png" },
