return {
  ...
  economicNews = {
    ...
    { text = "Oil prices surge on OPEC+ production cuts", breaking = true },
    "Housing starts drop 5% amid high rates",
    "Consumer confidence index rises to 78.4",
    "Retail sales up 0.6% month-over-month",
    "Powell: 'Data-dependent' approach continues",
    { text = "S&P 500 enters correction territory", breaking = true },
    "Bitcoin breaks $100K resistance level",
    "Gold hits new all-time high above $3,100",
    "PMI manufacturing expands for 4th month",
