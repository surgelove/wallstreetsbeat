return {
  ...
  canvasSprites = {
    { file = "bear.png",              scale = 0.35 },
    { file = "blob_fish.png",         scale = 0.30 },
    { file = "blond_suit.png",        scale = 0.35 },
    { file = "bucket.png",            scale = 0.40 },
    { file = "bull.png",              scale = 0.30 },
    { file = "diamond.png",           scale = 0.25 },
    { file = "diamond_hands.png",     scale = 0.30 },
    { file = "dive_dip.png",          scale = 0.40 },
    { file = "horse_squinting.png",   scale = 0.30 },
    { file = "leonardette.png",       scale = 0.30 },
    { file = "liquidate.png",         scale = 0.30 },
    { file = "milkshake.png",         scale = 0.35 },
    { file = "paper_hands.png",       scale = 0.30 },
    { file = "pink_scream_guy.png",   scale = 0.35 },
    { file = "play_ball.png",         scale = 0.20 },
    { file = "play_dog.png",          scale = 0.30 },
    { file = "play_paws.png",         scale = 0.25 },
    { file = "portfolio.png",         scale = 0.45 },
    { file = "replicator.png",        scale = 0.30 },
    { file = "rocket.png",            scale = 0.30 },
    { file = "smiling_visor_cat.png", scale = 0.30 },
    { file = "tendy.png",             scale = 0.25 },
    { file = "water_bear.png",        scale = 0.30 },
    { file = "wtf_girl.png",          scale = 0.30 },
  },
  canvasWsbScale = 0.55,
  stopStepPct = 0.001,
  debug = {
